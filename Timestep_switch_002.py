...
currentTS = raw_input("what is the current timestep in hours?:")
...
newTS = raw_input("what is the desired timestep in hours?:")
...
firstline = raw_input("what line down the file contains the column headers:")
